...
class SCS_Renderer():
    ...
    def render(self):
        ...
        while running:
            ...
            for i in range(GAME_HEIGHT):
                ...
                number_block = number_font.render(str(i+1), False, BLACK)
                ...
                for j in range(GAME_WIDTH):
                    ...
                    if i==0:
                        number_font = pygame.font.SysFont("uroob", 30)
                        number_block = number_font.render(str(j+1), False, BLACK)
            ...
            turn_block = turn_font.render(turn_text, False, BLACK)
    ...
    def analyse(self, game):
        ...
        GAME_HEIGHT = render_game.getBoardHeight()
        GAME_WIDTH = render_game.getBoardWidth()
        ...
        while running:
            ...
            action_block = action_font.render(action_text, True, RED)
            action_rect = action_block.get_rect(center=(WINDOW_WIDTH/2, 50))
            screen.blit(action_block, action_rect)


            turn_text = "Turn: " + str(render_game.current_turn)
            turn_font = pygame.font.SysFont("rachana", 25)
            turn_block = turn_font.render(turn_text, True, BLACK)
            ...
            action_number_block = action_number_font.render(action_number_text, True, GREEN)
            action_number_rect = action_number_block.get_rect(bottomleft=(5, WINDOW_HEIGHT-5))
            ...
            winner_block = winner_font.render(winner_text, True, ORANGE)
            winner_rect = winner_block.get_rect(bottomright=(WINDOW_WIDTH-5, WINDOW_HEIGHT-5))
